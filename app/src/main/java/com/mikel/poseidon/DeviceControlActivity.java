...
public class DeviceControlActivity extends Activity {
    ...
    private String isConnected = "Connected";
    ...
    private void updateConnectionState(final String resourceId) {
        ImageView checked = (ImageView) findViewById(R.id.click);
        TextView bpm = (TextView)findViewById(R.id.bpmhr);
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        /**____________________LINK TO CHARACTERISTIC________________________*/
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            if (gattService.getUuid().equals(UUID.fromString(HEART_RATE_SERVICE))) {
