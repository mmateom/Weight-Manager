...
import com.mikel.poseidon.Activities.notifications.WeightNReceiver;
...
public class Reminders extends AppCompatActivity implements NumberPicker.OnValueChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton home_button212 = (ImageButton) findViewById(R.id.homebutton);
        home_button212.setOnClickListener(view -> {
            Intent home_intent212 = new Intent(Reminders.this, Menu.class);
            home_intent212.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(home_intent212);
        });
...
//       age.setText(newVal);
    ...
    public void save() {
        ...
        if (min != -1) {
            ...
            Log.e(TAG, hour + ":" + min);
            Intent myIntent = new Intent(context, WeightNReceiver.class); //intent to BroadcastReveicer
