package com.mikel.poseidon.Activities.activity;
...
public class Tracker extends AppCompatActivity {
    ...
    TrackingService mService = new TrackingService();
    DBHelper myDB;
    ...
    private com.mikel.poseidon.Activities.utility.Chronometer mChrono;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = preferences.getString(ChooseActivity.ACTIVITY, "");
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent home_intent = new Intent(Tracker.this, Menu.class);
    ...
    public void setupBReceiver(){
        mStepsReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                isConnected = intent.getExtras().getBoolean("isConnected", false);


                if (TrackingService.BROADCAST_INTENT_STEPS.equals(action) ) {
                ...
                } else if (TrackingService.BROADCAST_INTENT_HEART_RATE.equals(action)) {
                    hr = intent.getExtras().getInt("heartrate", 0);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (!isConnected){
                                    calories = getCalories(getLastWeight(), activity);
                                    caloriesText.setText(String.valueOf(calories));
                                    Log.e("BLE monitor OFF", String.valueOf(isConnected));
                                }else {
  ...
  //          t.interrupt();
    ...
    private void startChrono(){
        if(mChrono == null) {
            ...
            mChrono = new com.mikel.poseidon.Activities.utility.Chronometer(context);
        ...
        if(pref.getBoolean(CHRONO_WAS_RUNNING, false)) {
            ...
            if(lastStartTime != 0) { //because 0 means value was not saved correctly!
                ...
                if(mChrono == null) { //make sure we dont create new instance and thread!
                    ...
                    mChrono = new com.mikel.poseidon.Activities.utility.Chronometer(context, lastStartTime);
    ...
    public void createNotification() {
        ...
        SharedPreferences preferences;
        preferences = getSharedPreferences(sharedPrefs, MODE_PRIVATE);
        String activity = preferences.getString(ChooseActivity.ACTIVITY, "");
    ...
    //// Intent filter for TrackingService broadcast intents

    private static IntentFilter makeStepServiceIntentFilter() {
        final IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(TrackingService.BROADCAST_INTENT_STEPS);
        intentFilter.addAction(TrackingService.BROADCAST_INTENT_HEART_RATE);
        return intentFilter;
    }
