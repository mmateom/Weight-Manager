...
public class WeatherNService extends Service {


    private static final String TAG = WeatherNService.class.getName();
        ...
        Awareness.SnapshotApi.getWeather(client)
                .setResultCallback(new ResultCallback<WeatherResult>() {
                    ...
                    public void onResult(@NonNull WeatherResult weatherResult) {
                        ...
                        if(weathenNotifOn && maxT != -1) {
                            if ((hour == 9) || (hour == 12) || (hour == 18)) {
                                if ((w.equals("Cloudy") || w.equals("Clear")) && temp > minT && temp <maxT) {
    ...
    private void foggyNotif() {
        ...
        NotificationCompat.Builder weightNotif = new NotificationCompat.Builder(context)
                .setContentTitle("Foogy weather. Be careful!")
