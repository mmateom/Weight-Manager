...
import com.mikel.poseidon.Activities.utility.ExplicitIntentGenerator;
...
public class TrackingService extends Service {
    ...
    public void broadcastSteps() {
        ...
        try {
            ...
            Log.e("Tracking Service Steps", e.getMessage());
        }
    ...
    public void broadcastHeartRate(){
        ...
        try {
            ...
            extras.putInt("heartrate", heart_rate);
            extras.putBoolean("isConnected", mHeartMonitorBonded);
            intent_hr.putExtras(extras);
            mContext.sendBroadcast(intent_hr);
        } catch (Exception e) {
            Log.e("Tracking Service HR", e.getMessage());
        }
