...
import com.mikel.poseidon.Activities.recordweight.FitbitRepository;
import com.mikel.poseidon.Activities.utility.FitbitApi20;

import org.fuckboilerplate.rx_social_connect.RxSocialConnect;


public class FitbitConnection extends AppCompatActivity {
    ...
    int mAge;
    String mGender;
    private static final String TAG = FitbitConnection.class.getName();

    public FitbitRepository repository;

        @Override protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_fitbit_con);

            //callback to home button
            ImageButton home_button = (ImageButton) findViewById(R.id.homebutton);
            home_button.setOnClickListener(view -> {

                Intent home_intent = new Intent(FitbitConnection.this, Menu.class);
                   ...
                   call.enqueue(new Callback<WeightArray>() {
                    ...
                    .subscribe(new Action1<Object>() {
                                   ...
                                   public void call(Object user) {
                                       FitbitConnection.this.showUserProfile(user.toString());
                                   }
                               },
                            error -> FitbitConnection.this.showError(error));
